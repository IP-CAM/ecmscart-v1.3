              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php if ($customer_ban_ip['total']) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><a href="<?php echo $customer_ban_ip['save']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
