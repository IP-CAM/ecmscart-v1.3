        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-local">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-file-manager-language"><span data-toggle="tooltip" data-container="#tab-local" title="<?php echo $help_filemanager; ?>"><?php echo $entry_file_manager_language; ?></span></label>
                <div class="col-sm-10">
                  <select name="config_filemanager_language" id="input-file-manager-language" class="form-control">
                    <?php foreach ($filemanagerLanguages as $key => $value) { ?>
                    <?php if ($key == $config_filemanager_language) { ?>
            ...
            <div class="tab-pane" id="tab-option">
			  ...
			  <fieldset>
				...
				<div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_blog_footer; ?>"><?php echo $entry_blog_footer; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_blog_footer) { ?>
                      <input type="radio" name="config_blog_footer" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_blog_footer" value="1" />
                      <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_blog_footer) { ?>
                      <input type="radio" name="config_blog_footer" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_blog_footer" value="0" />
                      <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_blog_comment; ?>"><?php echo $entry_blog_comment; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_blog_comment_status) { ?>
                      <input type="radio" name="config_blog_comment_status" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_blog_comment_status" value="1" />
                      <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_blog_comment_status) { ?>
                      <input type="radio" name="config_blog_comment_status" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_blog_comment_status" value="0" />
                      <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_blog_comment_guest; ?>"><?php echo $entry_blog_comment_guest; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_blog_comment_mail; ?>"><?php echo $entry_blog_comment_mail; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
            ...
            <div class="tab-pane" id="tab-image">
			  ...
			  <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-image-family-width"><?php echo $entry_image_family; ?></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
                      <input type="text" name="config_image_family_width" value="<?php echo $config_image_family_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-family-width" class="form-control" />
                    </div>
                    <div class="col-sm-6">
                      <input type="text" name="config_image_family_height" value="<?php echo $config_image_family_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                    </div>
                  </div>
                  <?php if ($error_image_family) { ?>
                  <div class="text-danger"><?php echo $error_image_family; ?></div>
                  <?php } ?>
                </div>
              </div>	
			  <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-thumb-family-width"><?php echo $entry_thumb_family; ?></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
                      <input type="text" name="config_thumb_family_width" value="<?php echo $config_thumb_family_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-thumb-family-width" class="form-control" />
                    </div>
                    <div class="col-sm-6">
                      <input type="text" name="config_thumb_family_height" value="<?php echo $config_thumb_family_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                    </div>
                  </div>
                  <?php if ($error_thumb_family) { ?>
                  <div class="text-danger"><?php echo $error_thumb_family; ?></div>
                  <?php } ?>
                </div>
              </div>			  
			  <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-image-blog-width"><?php echo $entry_image_blog; ?></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
                      <input type="text" name="config_image_blog_width" value="<?php echo $config_image_blog_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-blog-width" class="form-control" />
                    </div>
                    <div class="col-sm-6">
                      <input type="text" name="config_image_blog_height" value="<?php echo $config_image_blog_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                    </div>
                  </div>
			  ...
			  <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-thumb-blog-width"><?php echo $entry_thumb_blog; ?></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
                      <input type="text" name="config_thumb_blog_width" value="<?php echo $config_thumb_blog_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-thumb-blog-width" class="form-control" />
                    </div>
                    <div class="col-sm-6">
                      <input type="text" name="config_thumb_blog_height" value="<?php echo $config_thumb_blog_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                    </div>
                  </div>
                  <?php if ($error_thumb_blog) { ?>
                  <div class="text-danger"><?php echo $error_thumb_blog; ?></div>
                  <?php } ?>
                </div>
              </div>
			  <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-image-author-width"><?php echo $entry_image_author; ?></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
                      <input type="text" name="config_image_author_width" value="<?php echo $config_image_author_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-author-width" class="form-control" />
                    </div>
                    <div class="col-sm-6">
                      <input type="text" name="config_image_author_height" value="<?php echo $config_image_author_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                    </div>
                  </div>
                  <?php if ($error_image_author) { ?>
                  <div class="text-danger"><?php echo $error_image_author; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
