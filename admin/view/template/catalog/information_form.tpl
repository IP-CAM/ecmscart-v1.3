              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">					
                      <input type="text" name="information_keyword[<?php echo $language['language_id']; ?>][keyword]" value="<?php echo isset($information_keyword[$language['language_id']]) ? $information_keyword[$language['language_id']]['keyword'] : ''; ?>" placeholder="<?php echo $entry_keyword; ?>" id="input-keyword<?php echo $language['language_id']; ?>" class="form-control" />
