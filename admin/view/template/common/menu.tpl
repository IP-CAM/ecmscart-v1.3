<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
   ...
   <li id="blog"><a class="parent"><i class="fa fa-pencil fa-fw"></i> <span><?php echo $text_blogger; ?></span></a>
    <ul>
	  <li><a href="<?php echo $family; ?>"><?php echo $text_family; ?></a></li>
	  <li><a href="<?php echo $author; ?>"><?php echo $text_author; ?></a></li>      
      <li><a href="<?php echo $article; ?>"><?php echo $text_blog; ?></a></li>
