<!DOCTYPE html>
<html dir="<?php echo $direction; ?>" lang="<?php echo $code; ?>"><head>
<meta charset="UTF-8" />
...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    <?php if ($logged) { ?>
    <a type="button" id="button-left-menu" class="pull-left"><i class="fa fa-indent fa-lg"></i></a>
  ...
  <ul class="nav pull-right">
    <li class="dropdown"><a type="button" id="button-right-menu" class="pull-right"><i class="fa fa-indent fa-lg"></i></a></li>
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-life-ring fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right">
        ...
        <li><a href="http://www.ecmscart.com" target="_blank"><?php echo $text_homepage; ?></a></li>
       
        <li><a href="http://forum.ecmscart.com" target="_blank"><?php echo $text_support; ?></a></li>
      </ul>
    </li>
