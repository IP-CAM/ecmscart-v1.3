      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-comment" class="form-horizontal">
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-commenter"><?php echo $entry_commenter; ?></label>
            <div class="col-sm-10">
              <input type="text" name="commenter" value="<?php echo $commenter; ?>" placeholder="<?php echo $entry_commenter; ?>" id="input-commenter" class="form-control" />
              <?php if ($error_commenter) { ?>
              <div class="text-danger"><?php echo $error_commenter; ?></div>
              <?php } ?>
            </div>
          </div>
          <div class="form-group required">
