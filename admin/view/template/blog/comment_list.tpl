...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $save; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label class="control-label" for="input-blog"><?php echo $entry_blog; ?></label>
                <input type="text" name="filter_blog" value="<?php echo $filter_blog; ?>" placeholder="<?php echo $entry_blog; ?>" id="input-blog" class="form-control" />
              </div>
              <div class="form-group">
                <label class="control-label" for="input-commenter"><?php echo $entry_commenter; ?></label>
                <input type="text" name="filter_commenter" value="<?php echo $filter_commenter; ?>" placeholder="<?php echo $entry_commenter; ?>" id="input-commenter" class="form-control" />
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'ad.title') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'c.commenter') { ?>
                    <a href="<?php echo $sort_commenter; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_commenter; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_commenter; ?>"><?php echo $column_commenter; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $comment['commenter']; ?></td>
                  <td class="text-left"><?php echo $comment['status']; ?></td>
                  <td class="text-left"><?php echo $comment['date_added']; ?></td>
                  <td class="text-right"><a href="<?php echo $comment['save']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
...
$('#button-filter').on('click', function() {
	...
	var filter_commenter = $('input[name=\'filter_commenter\']').val();
	
	if (filter_commenter) {
		url += '&filter_commenter=' + encodeURIComponent(filter_commenter);
	}
