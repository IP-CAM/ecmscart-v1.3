...
class ModelOpenbayEtsy extends Model{
	...
	public function uninstall() {
		$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "etsy_setting_option`;");
		$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "etsy_listing`;");
		$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "etsy_order`;");
		$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "etsy_order_lock`;");
