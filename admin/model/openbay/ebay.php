...
{country}';
	...
	public function uninstall() {
		...
		$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "ebay_order_lock`;");
		...
		$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "ebay_stock_reserve`;");
		$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "ebay_template`;");
