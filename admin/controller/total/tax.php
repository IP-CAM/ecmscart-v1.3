...
class ControllerTotalTax extends Controller {
	...
	public function index() {
		$this->data = $this->load->language('total/tax');
		...
		$this->data['breadcrumbs'] = $this->config->breadcrums(array(
							...
							$this->url->link('total/tax', 'token=' . $this->session->data['token'], 'SSL')
						));
		...
		$this->data['tax_status'] = $this->request->post('tax_status', $this->config->get('tax_status'));
		
		$this->data['tax_sort_order'] = $this->request->post('tax_sort_order', $this->config->get('tax_sort_order'));	
		...
		$this->response->setOutput($this->load->view('total/tax.tpl', $this->data));
	}
