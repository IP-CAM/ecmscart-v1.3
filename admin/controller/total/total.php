...
class ControllerTotalTotal extends Controller {
	...
	public function index() {
		...
		$this->data['breadcrumbs'] = $this->config->breadcrums(array(
							...
							$this->url->link('total/total', 'token=' . $this->session->data['token'], 'SSL')
						));
		...
		$this->data['total_status'] = $this->request->post('total_status', $this->config->get('total_status'));
		
		$this->data['total_sort_order'] = $this->request->post('total_sort_order', $this->config->get('total_sort_order'));
		...
		$this->response->setOutput($this->load->view('total/total.tpl', $this->data));
	}
