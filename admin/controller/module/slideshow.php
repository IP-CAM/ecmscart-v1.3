...
class ControllerModuleSlideshow extends Controller {
	...
	public function index() {
		$this->data = $this->load->language('module/slideshow');
		...
		if (!isset($this->request->get['module_id'])) {// dyanamic adding module url for module_id
			$module_url = $this->url->link('module/slideshow', 'token=' . $this->session->data['token'], 'SSL');
			
		} else {
			$module_url = $this->url->link('module/slideshow', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');			
		}
		...
		if (!isset($this->request->get['module_id'])) {
			...
			$this->data['action'] = $this->url->link('module/slideshow', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');
		}
		...
		} elseif (!empty($module_info)  && !$this->error) {
		...
		$this->response->setOutput($this->load->view('module/slideshow.tpl', $this->data));
	}
