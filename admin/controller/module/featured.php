...
class ControllerModuleFeatured extends Controller {
	...
	public function index() {
		$this->data = $this->load->language('module/featured');
		...
		if (!isset($this->request->get['module_id'])) {// dyanamic adding module url for module_id
			$module_url = $this->url->link('module/featured', 'token=' . $this->session->data['token'], 'SSL');
			
		} else {
			$module_url = $this->url->link('module/featured', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');			
		}
		...
		if (!isset($this->request->get['module_id'])) {
			...
			$this->data['action'] = $this->url->link('module/featured', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');
		}
		...
		$this->data['name'] = $this->request->post('name',(!empty($module_info)?$module_info['name']:'test'),false);
		...
		if (!empty($module_info) && !$this->error) {
			...
			$products =$this->request->post('product', array());
		}	
		...
		$this->response->setOutput($this->load->view('module/featured.tpl', $this->data));
	}
