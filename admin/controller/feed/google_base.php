...
class ControllerFeedGoogleBase extends Controller {
	...
	public function index() {
		$this->data = $this->load->language('feed/google_base');
		...
		$this->data['breadcrumbs'] = $this->config->breadcrums(array(
							...
							$this->url->link('feed/google_base', 'token=' . $this->session->data['token'], 'SSL'),	// Link URL
						));
		...
		$this->data['google_base_status'] = $this->request->post('google_base_status', $this->config->get('google_base_status'), false);
		...
		$this->response->setOutput($this->load->view('feed/google_base.tpl', $this->data));
	}
