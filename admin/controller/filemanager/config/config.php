...
$base_url =
	// Get HTTP/HTTPS
	((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && !in_array(strtolower($_SERVER['HTTPS']),array('off','no'))) ? HTTPS_CATALOG : HTTP_CATALOG); // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir = 'image/catalog/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../image/catalog/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../image/cache/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
