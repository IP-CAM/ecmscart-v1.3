...
<html xmlns="https://www.w3.org/1999/xhtml">
  ...
  <link href="css/style.css" rel="stylesheet" type="text/css" />
	...
	<script type="text/javascript" src="js/include.js"></script><!--for fancybox close script change from include.min.js to include.js by manish-->
</head>
<body>
...
<script>
    ...
    <div class="modal hide fade" id="previewAV">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;X</button>
