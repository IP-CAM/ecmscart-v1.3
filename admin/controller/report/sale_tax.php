...
class ControllerReportSaleTax extends Controller {
	...
	public function index() {
		$this->data = $this->load->language('report/sale_tax');
		...
		$this->data['breadcrumbs'] = $this->config->breadcrums(array(
							...
							$this->url->link('report/sale_tax', 'token=' . $this->session->data['token'] . $url, 'SSL')	// Link URL
						));
		...
		$this->response->setOutput($this->load->view('report/sale_tax.tpl', $this->data));
	}
}