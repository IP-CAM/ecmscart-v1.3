...
class ControllerReportCustomerReward extends Controller {
	...
	public function index() {
		$this->data = $this->load->language('report/customer_reward');
		...
		$this->data['breadcrumbs'] = $this->config->breadcrums(array(
							...
							$this->url->link('report/customer_reward', 'token=' . $this->session->data['token'] . $url, 'SSL')	// Link URL
						));
		...
		$this->response->setOutput($this->load->view('report/customer_reward.tpl', $this->data));
	}
}