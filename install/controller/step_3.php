...
class ControllerStep3 extends Controller {
	...
	public function index() {
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$output  = '<?php' . "\n";
			$output .= '// HTTP' . "\n";
			$output .= 'define(\'HTTP_SERVER\', \'' . HTTP_ECMSCART . '\');' . "\n\n";

			$output .= '// HTTPS' . "\n";
			$output .= 'define(\'HTTPS_SERVER\', \'' . HTTP_ECMSCART . '\');' . "\n\n";
			...
			$output .= 'define(\'DIR_UPLOAD\', \'' . DIR_ECMSCART . 'system/upload/\');' . "\n";
			...
			$output  = '<?php' . "\n";
			$output .= '// HTTP' . "\n";
			$output .= 'define(\'HTTP_SERVER\', \'' . HTTP_ECMSCART . 'admin/\');' . "\n";
			$output .= 'define(\'HTTP_CATALOG\', \'' . HTTP_ECMSCART . '\');' . "\n\n";

			$output .= '// HTTPS' . "\n";
			$output .= 'define(\'HTTPS_SERVER\', \'' . HTTP_ECMSCART . 'admin/\');' . "\n";
			$output .= 'define(\'HTTPS_CATALOG\', \'' . HTTP_ECMSCART . '\');' . "\n\n";
	...
	private function validate() {
		...
		if (!is_writable(DIR_ECMSCART . 'config.php')) {
			$this->error['warning'] = $this->language->get('error_config') . DIR_ECMSCART . 'config.php!';
		}

		if (!is_writable(DIR_ECMSCART . 'admin/config.php')) {
			$this->error['warning'] = $this->language->get('error_config') . DIR_ECMSCART . 'admin/config.php!';
		}
