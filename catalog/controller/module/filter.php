		...
		if ($category_info) {
			...
			if ($filter_groups) {
				...
				if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/filter.tpl')) {
					return $this->load->view($this->config->get('config_template') . '/template/module/filter.tpl', $this->data);
				} else {
					return $this->load->view('default/template/module/filter.tpl', $this->data);
				}
			}
		}
	}
