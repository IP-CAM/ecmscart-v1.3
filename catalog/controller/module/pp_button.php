	...
	public function index() {
		...
		if ($status) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/pp_button.tpl')) {
				return $this->load->view($this->config->get('config_template') . '/template/module/pp_button.tpl', $this->data);
			} else {
				return $this->load->view('default/template/module/pp_button.tpl', $this->data);
			}
		}
	}
}