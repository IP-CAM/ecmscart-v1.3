...
class ControllerCommonCart extends Controller {
	public function index() {
		$this->data = $this->load->language('common/cart');
		...
		$this->data['text_items'] = sprintf($this->data['text_items'], $this->cart->countProducts() + (isset($this->session->data['vouchers']) ? count($this->session->data['vouchers']) : 0), $this->currency->format($total));
