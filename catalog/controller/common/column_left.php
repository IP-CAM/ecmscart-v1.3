...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/column_left.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/common/column_left.tpl', $this->data);
		} else {
			return $this->load->view('default/template/common/column_left.tpl', $this->data);
		}
	}
}