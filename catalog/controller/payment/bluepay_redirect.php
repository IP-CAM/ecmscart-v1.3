...
class ControllerPaymentBluePayRedirect extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/bluepay_redirect.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/bluepay_redirect.tpl', $this->data);
		} else {
			return $this->load->view('default/template/payment/bluepay_redirect.tpl', $this->data);
		}
	}
