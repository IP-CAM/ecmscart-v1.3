...
class ControllerPaymentPPStandard extends Controller {
	public function index() {
		...
		if ($order_info) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/pp_standard.tpl')) {
				return $this->load->view($this->config->get('config_template') . '/template/payment/pp_standard.tpl', $this->data);
			} else {
				return $this->load->view('default/template/payment/pp_standard.tpl', $this->data);
			}
		}
	}
	...
	public function callback() {
		...
		$order_id = $this->request->post('custom',0);
