...
class ControllerPaymentTwoCheckout extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/twocheckout.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/twocheckout.tpl', $this->data);
		} else {
			return $this->load->view('default/template/payment/twocheckout.tpl', $this->data);
		}
	}
	...
	public function callback() {
		...
		$order_number = $this->request->post('order_number',1);
