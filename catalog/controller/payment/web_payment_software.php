...
class ControllerPaymentWebPaymentSoftware extends Controller {
	public function index() {
		...
		$this->data['text_credit_card'] = $this->data['text_credit_card'];
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/web_payment_software.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/web_payment_software.tpl', $this->data);
		} else {
			return $this->load->view('default/template/payment/web_payment_software.tpl', $this->data);
		}
	}
