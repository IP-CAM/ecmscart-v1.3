...
class ControllerPaymentSagepayServer extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/sagepay_server.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/sagepay_server.tpl', $this->data);
		} else {
			return $this->load->view('default/template/payment/sagepay_server.tpl', $this->data);
		}
	}
	...
	public function failure() {
		...
		$this->session->data['error'] = $this->data['text_generic_error'];
