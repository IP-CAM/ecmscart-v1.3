...
class ControllerPaymentAmazonCheckout extends Controller {
	public function address() {
		...
		$this->data['shipping_quotes'] = $this->url->link('payment/amazon_checkout/shippingquotes', '', 'SSL');
		$this->data['payment_method'] = $this->url->link('payment/amazon_checkout/paymentmethod', '', 'SSL');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/amazon_checkout_address.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/payment/amazon_checkout_address.tpl', $this->data));
		} else {
			$this->response->setOutput($this->load->view('default/template/payment/amazon_checkout_address.tpl', $this->data));
		}
	}
	...
	public function paymentMethod() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/amazon_checkout_payment.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/payment/amazon_checkout_payment.tpl', $this->data));
		} else {
			$this->response->setOutput($this->load->view('default/template/payment/amazon_checkout_payment.tpl', $this->data));
		}
	}
	...
	public function confirm() {
		...
		$order_data['payment_method'] = $this->data['text_cba'];
		...
		$this->data['merchant_id'] = $this->config->get('amazon_checkout_merchant_id');
		$this->data['process_order'] = $this->url->link('payment/amazon_checkout/processorder', '', 'SSL');
		...
		$this->data['text_back'] = $this->data['text_back'];
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/amazon_checkout_confirm.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/payment/amazon_checkout_confirm.tpl', $this->data));
		} else {
			$this->response->setOutput($this->load->view('default/template/payment/amazon_checkout_confirm.tpl', $this->data));
		}
	}
	...
	public function success() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/amazon_checkout_success.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/payment/amazon_checkout_success.tpl', $this->data));
		} else {
			$this->response->setOutput($this->load->view('default/template/payment/amazon_checkout_success.tpl', $this->data));
		}
	}
	...
	public function failure() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/amazon_checkout_failure.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/payment/amazon_checkout_failure.tpl', $this->data));
		} else {
			$this->response->setOutput($this->load->view('default/template/payment/amazon_checkout_failure.tpl', $this->data));
		}
	}
	...
	public function shippingQuotes() {
		...
		if (isset($xml->GetPurchaseContractResult->PurchaseContract->Destinations->Destination[0]->PhysicalDestinationAttributes->ShippingAddress)) {
			...
			if (empty($quotes)) {
				$json['error'] = $this->data['error_no_shipping_methods'];
			} else {
				$json['quotes'] = $quotes;
			}
			...
			$json['error'] = $this->data['error_shipping_methods'];
		}
