...
class ControllerPaymentBluePayHostedForm extends Controller {
	public function index() {
		...
		$this->data['text_loading'] = $this->data['text_loading'];

		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/bluepay_hosted.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/bluepay_hosted.tpl', $this->data);
		} else {
			return $this->load->view('default/template/payment/bluepay_hosted.tpl', $this->data);
		}
	}
