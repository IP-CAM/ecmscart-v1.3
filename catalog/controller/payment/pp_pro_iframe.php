...
class ControllerPaymentPPProIframe extends Controller {
	public function index() {
		...
		$this->data = $this->language->load('payment/pp_pro_iframe');
		...
		if ($this->config->get('pp_pro_iframe_checkout_method') == 'redirect') {
			...
			if ($hosted_button_id) {
				...
				$this->data['error_connection'] = $this->data['error_connection'];
			}
		}
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/pp_pro_iframe.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/pp_pro_iframe.tpl', $this->data);
		} else {
			return $this->load->view('default/template/payment/pp_pro_iframe.tpl', $this->data);
		}
	}
	...
	public function create() {
		...
		$this->data['text_secure_connection'] = $this->data['text_secure_connection'];
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/pp_pro_iframe_body.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/payment/pp_pro_iframe_body.tpl', $this->data));
		} else {
			$this->response->setOutput($this->load->view('default/template/payment/pp_pro_iframe_body.tpl', $this->data));
		}
	}
