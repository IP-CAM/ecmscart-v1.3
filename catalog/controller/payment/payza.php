...
class ControllerPaymentPayza extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payza.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/payza.tpl', $this->data);
		} else {
			return $this->load->view('default/template/payment/payza.tpl', $this->data);
		}
	}
