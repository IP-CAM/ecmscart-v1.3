...
class ControllerPaymentNochex extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/nochex.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/nochex.tpl', $this->data);
		} else {
			return $this->load->view('default/template/payment/nochex.tpl', $this->data);
		}
	}
	...
	public function callback() {
		...
		if (isset($this->request->get['method']) && $this->request->get['method'] == 'decline') {
			$this->session->data['error'] = $this->data['error_declined'];
		...
		if (!$order_info) {
			$this->session->data['error'] = $this->data['error_no_order'];
