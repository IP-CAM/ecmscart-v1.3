...
class ControllerProductSearch extends Controller {
	public function index() {
		$this->data = $this->load->language('product/search');
		...
		if (isset($this->request->get['search'])) {
			$this->document->setTitle($this->data['heading_title'] .  ' - ' . $this->request->get['search']);
		} elseif (isset($this->request->get['tag'])) {
			$this->document->setTitle($this->data['heading_title'] .  ' - ' . $this->data['heading_tag'] . $this->request->get['tag']);
		} else {
		...
		if (isset($this->request->get['search'])) {
			$this->data['heading_title'] = $this->data['heading_title'] .  ' - ' . $this->request->get['search'];
		} else {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/search.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/product/search.tpl', $this->data));
		} else {
			$this->response->setOutput($this->load->view('default/template/product/search.tpl', $this->data));
		}
	}
}