...
class ControllerProductCategory extends Controller {
	public function index() {
		$this->data = $this->load->language('product/category');
		...
		if ($category_info) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/category.tpl')) {
				$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/product/category.tpl', $this->data));
			} else {
				$this->response->setOutput($this->load->view('default/template/product/category.tpl', $this->data));
			}
		} else {
			$url = '';
			...
			$this->data['breadcrumbs'] = $this->config->breadcrums(array(
							...
							$this->url->link('product/category', $url)		// Link URL
