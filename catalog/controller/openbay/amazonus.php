...
class ControllerOpenbayAmazonus extends Controller {
	public function order() {
		...
		$this->data = $this->language->load('openbay/amazonus_order');
	...
	public function listing() {
		...
		if ($this->data['status']) {
			$logger->write("Updating " . $this->data['product_id'] . ' as successful');
			$this->model_openbay_amazonus_listing->listingSuccessful($this->data['product_id']);
			$this->model_openbay_amazonus_product->linkProduct($this->data['sku'], $this->data['product_id']);
			$logger->write("Updated successfully");
		} else {
			$logger->write("Updating " . $this->data['product_id'] . ' as failed');
			$this->model_openbay_amazonus_listing->listingFailed($this->data['product_id'], $this->data['messages']);
			$logger->write("Updated successfully");
		}
	}
	...
	public function listingReport() {
		...
		if ($this->data) {
			$this->model_openbay_amazonus_product->addListingReport($this->data);
		}
	...
	public function product() {
		...
		$this->data = $this->openbay->amazonus->decryptArgs($this->request->post['data']);
		if(!$this->data) {
